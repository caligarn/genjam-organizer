...
export function EventTimer({ currentStep, deadline, className }: EventTimerProps) {
  ...
  return (
    <div className={cn('space-y-20 sm:space-y-24', className)}>
      {/* Countdown Timer Card - Machine Cinema style */}
      <div
        className={cn(
          'rounded-2xl p-32 sm:p-40 text-center transition-all duration-500 border-3',
          isExpired
      ...
      >
        <div className="flex items-center justify-center gap-10 mb-32">
        ...
        <div className="flex items-center justify-center gap-24 sm:gap-32">
        ...
        {isWarning && !isExpired && (
          <p className="mt-24 text-sm font-bold animate-pulse bg-white/20 rounded-full px-6 py-2 inline-block uppercase">
      ...
      <div 
        className="bg-white rounded-2xl p-24 sm:p-32 border-3"
        style={{ 
          borderWidth: '3px',
          borderColor: '#1a1a1a',
