  ...
  return (
    ...
    >
      ...
      <div className="space-y-[10rem] sm:space-y-[13rem]">
        ...
        <div className="card">
          <h2 className="text-xl font-bold text-gray-900 mb-[10rem] flex items-center gap-2">
            📍 Venue Information
          </h2>

          <div className="space-y-[8rem]">
            {/* WiFi Info */}
            <div className="flex items-start gap-[5rem] p-[8rem] bg-gray-50 rounded-2xl">
            ...
            {/* Important Reminders */}
            <div className="p-[8rem] bg-amber-50 border border-amber-200 rounded-2xl">
              <div className="flex items-start gap-[5rem]">
                <AlertTriangle className="w-6 h-6 text-amber-600 mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-amber-800 mb-[4rem]">Important Reminders:</h3>
                  <ul className="space-y-[4rem] text-sm text-amber-700">
